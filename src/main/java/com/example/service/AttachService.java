...
public class AttachService {
    ...
    public String saveToSystem(MultipartFile file) { // image.png
        try {
            ...
            Path path = Paths.get("attaches/" + file.getOriginalFilename()); // attaches/image.png
   ...
   /* public byte[] loadImage(String fileName) { // image.jpg
    ...
    public AttachDTO save(MultipartFile file) { // image.png
        try {
